                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">
                                        Welcome <span class="fw-bold fst-italic">YASIR</span>, Manage your savings and track
                ...
                <div class="col-12 order-3 order-md-2">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-12 mb-4">
                            <div class="card border-0 border-bottom border-3 border-info">
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar">
                                            <span class="avatar-initial rounded bg-label-info">
                                                <i class="icon-base bx bx-notepad icon-lg"></i>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar">
                                            <span class="avatar-initial rounded bg-label-warning">
                                                <i class="icon-base bx bx-money-withdraw icon-lg"></i>
                                            </span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <div class="avatar">
                                                <span class="avatar-initial rounded bg-label-danger">
                                                    <i class="icon-base bx bx-credit-card icon-lg"></i>
                                                </span>
                                            </div>
                                        </div>
                                        <span class="fw-semibold d-block mb-1">Angsuran Bulanan</span>
                                        <h3 class="card-title text-nowrap mb-2">Rp. 1.000.000</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-0 border-bottom border-3 border-success">
                                <div class="card ">
                                    <div class="card-body">
                                        ...
                                        <span class="fw-semibold d-block mb-1">Saldo Simpanan</span>
