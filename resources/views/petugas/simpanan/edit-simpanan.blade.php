                ...
                <div class="col-lg-12 mb-4 ">
                    <div class="card border-0 border-bottom border-3 border-primary">
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    <h3 class="card-title text-primary">EDIT SIMPANAN</h3>
                                    <p class="mb-4">
                                        Anda dapat memperbarui data simpanan anggota di halaman ini.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="col-lg-12 mb-4">
                    <div class="card pb-3 border-0 border-bottom border-3 border-primary">
                        ...
                        <form id="formAuthentication" class="mb-3 mx-4"
                            action="{{ url('petugas/simpanan/' . $simpanan->id) }}" method="POST">
