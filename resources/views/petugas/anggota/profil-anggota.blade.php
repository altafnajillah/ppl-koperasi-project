                        ...
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    ...
                                    <p class="mb-4">
                                        Welcome <span class="fw-bold fst-italic">{{ $anggota->name }}</span>, let's
                        ...
                        <div class="row px-2 gx-3">
                            ...
                            <div class="card-body col-lg-10">
                                <form id="formAccountSettings" method="POST"
                                    action="{{ route('petugas.anggota.acceptBiodata', $anggota->id) }}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-12">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" value="{{ $anggota->biodata->no_hp }}" id="no_hp"
                                                    name="no_hp" class="form-control" placeholder="202 555 0111" />
                                            </div>
                                        </div>
                                        <div class="mb-3 col-12">
                                        ...
                                        <div class="mb-3 col-12">
                                            ...
                                            <div class="d-flex align-items-start align-items-sm-center mt-2">
                                                <img src="{{ asset('templates') }}/assets/img/avatars/1.png"
                                                    alt="user-avatar" class="d-block rounded" height="180"
                                                    width="320" id="uploadedAvatar" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-2 row gx-2">
                                        <div class="col-lg-12 col-6">
                                            <button type="submit"
                                                class="btn {{ $anggota->biodata->accepted_at == null ? 'btn-success' : 'btn-secondary' }} w-100"
