            ...
            <div class="row">
                <div class="col-lg-12 mb-4 ">
                    <div class="card border-0 border-bottom border-3 border-primary">
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                                <div class="card-body">
                                    <h3 class="card-title text-primary">TAMBAH ANGSURAN</h3>
                                    <p class="mb-4">
                ...
                <div class="col-lg-12 mb-4">
                    <div class="card pb-3 border-0 border-bottom border-3 border-primary">
                        <h5 class="card-header">Tambah Angsuran Baru</h5>
                        ...
                        <form id="formAuthentication" class="mb-3 mx-4" action="" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="email" class="form-label">Tanggal Pembayaran</label>
