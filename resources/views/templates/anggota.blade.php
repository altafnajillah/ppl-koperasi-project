    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
                ...
                <span class="app-brand-text demo menu-text fw-bolder ms-2 text-uppercase">koperasiku</span>
            </a>
        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ Request::is('anggota/dashboard*') ? 'active' : '' }}">
                <a href="{{ url('anggota/dashboard') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx bx-grid-alt"></i>
...
@section('footer')
    <div class="bg-primary py-4 px-5">
        <div class="row">
            <div class="col-lg-9 col-md-8 order-2 order-md-1">
                <div class="text-white mb-3">
                    <i class="bi bi-envelope bg-white text-primary rounded-circle p-1 me-2"></i>
                    koperasiku@koperasi.com
                </div>
                <div class="text-white">
                    <i class="bi bi-telephone bg-white text-primary rounded-circle p-1 me-2"></i>
                    +62 812-3456-7890
                </div>
            </div>
            <div class="col-lg-3 col-md-4 order-1 order-md-2 mb-lg-1 mb-md-1 mb-4">
                <a href="/" class="app-brand-link gap-2">
                    ...
                    <span class="app-brand-text fw-bolder text-white fs-1">Koperasiku</span>
                </a>
            </div>
        </div>
    </div>
    <footer class="" style="background-color: #636CCB">
        <div class="container-xxl d-flex py-2 flex-md-row flex-column justify-content-center align-items-center">
