    ...
    <div class="container-xxl m-5">
        ...
        <div class="app-brand justify-content-center">
            <a href="/" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bolder">Kopersaiku</span>
            </a>
        </div>
        <!-- /Logo -->

        <div class="authentication col-sm-10 col-lg-6 col-xl-6 mx-auto">
            <div class="authentication-inner pt-5">
                <!-- Register -->
                <div class="card">
                    <div class="card-body">
